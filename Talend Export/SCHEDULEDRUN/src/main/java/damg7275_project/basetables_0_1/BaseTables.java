...
package damg7275_project.basetables_0_1;
...
/**
 * Job: BaseTables Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class BaseTables implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "BaseTables";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(BaseTables.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		damg7275_project.geolocation_0_1.Geolocation childJob_tRunJob_1 = new damg7275_project.geolocation_0_1.Geolocation();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		damg7275_project.customer_0_1.Customer childJob_tRunJob_2 = new damg7275_project.customer_0_1.Customer();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		damg7275_project.seller_0_1.Seller childJob_tRunJob_3 = new damg7275_project.seller_0_1.Seller();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		damg7275_project.products_0_1.Products childJob_tRunJob_7 = new damg7275_project.products_0_1.Products();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		damg7275_project.orders_0_1.Orders childJob_tRunJob_4 = new damg7275_project.orders_0_1.Orders();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		damg7275_project.orderpayments_0_1.OrderPayments childJob_tRunJob_5 = new damg7275_project.orderpayments_0_1.OrderPayments();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		damg7275_project.orderreviews_0_1.OrderReviews childJob_tRunJob_6 = new damg7275_project.orderreviews_0_1.OrderReviews();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final BaseTables BaseTablesClass = new BaseTables();

        int exitCode = BaseTablesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = BaseTables.class.getClassLoader().getResourceAsStream("damg7275_project/basetables_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = BaseTables.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : BaseTables");
        }
...
/************************************************************************************************
 *     69043 characters generated by Talend Open Studio for Data Integration 
